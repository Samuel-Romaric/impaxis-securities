...
@section('content')
    ...
    <section class="banner-section" style="background: linear-gradient(135deg, #000000 0%, #001a4d 100%); padding: 150px 20px; text-align: center; min-height: 400px; display: flex; align-items: center; justify-content: center;">
        <div class="banner-content">
            <h1 style="color: white; font-size: 64px; font-weight: 700; margin: 0; letter-spacing: 2px;">Devenir client</h1>
        </div>
    </section>
    <!-- Contact -->
    ...
    <section class="container my-5" style="padding-top: 40px; padding-bottom: 40px;">
        <div class="row">
            ...
            <div class="col-md-8">
                <h2 style="font-size: 32px; font-weight: 600; line-height: 1.2; margin-bottom: 20px; text-align: center">Ecrivez-nous via ce formulaire</h2>
                <div class="card">
                    <div class="card-body">
                        <form>
                            @csrf
